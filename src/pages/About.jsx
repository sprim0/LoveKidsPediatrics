...
const About = () => {
  ...
  const staffMembers = [
    { name: 'Jayda Moye', role: 'Medical Assistant', image: staff1Image },
    { name: 'Monique Bell', role: 'Biller/Office Manager', image: staff2Image },
    { name: 'Chonece Milner', role: 'Receptionist', image: staff3Image },
  ];
          ...
          <div className="doctor-container">
            ...
            <div className="doctor-content">
              <div className="doctor-name-title">
                <h2>Dr. Yvonne M. Jackson, MD, FAAP</h2>
              ...
              <div className="doctor-bio">
                <p>
                  ...
                  community for over 30 years. Her approach combines evidence-based medicine with 
                  a genuine love for children and their families.
                </p>
                <p>
                  After completing her pediatric residency at the University of Maryland, 
                  Dr. Jackson founded Love Kids with a simple mission: to provide the 
                  kind of care she would want for her own child.
                </p>
                <p>
                  When she's not caring for patients, Dr. Jackson enjoys spending time with her 
                  child, gardening, and volunteering at local schools to promote 
              ...
              <div className="doctor-education">
                ...
                <ul>
                  <li>MD, Howard University College of Medicine</li>
                  <li>Pediatric Residency, University of Maryland</li>
                  <li>BS Biology, Virginia Commonwealth University</li>
                </ul>
              </div>
