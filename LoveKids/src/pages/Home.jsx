        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <p className="hero-description">
              Welcome to Jackson Pediatrics, where every child receives personalized, 
            ...
            <div className="hero-actions">
              ...
              <a href="tel:5551234567" className="btn btn-secondary btn-lg">
                Call (555) 123-4567
              </a>
            </div>
          ...
          <div className="why-container">
            <div className="why-content">
              ...
              <p className="why-intro">
                For over 20 years, families have trusted Jackson Pediatrics with their children's 
              ...
              <div className="contact-details">
                <div className="contact-item">
                  ...
                  <div className="contact-item-content">
                    <h4>Location</h4>
                    <p>123 Healthcare Blvd, Suite 100<br />City, State 12345</p>
                  </div>
                </div>
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <div className="cta-actions">
              ...
              <a href="tel:5551234567" className="btn btn-outline-white btn-lg">
                Call Us Today
              </a>
            </div>
          </div>
